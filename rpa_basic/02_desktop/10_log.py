...
# logging.basicConfig(level=logging.INFO, format="%(asctime)s [%(levelname)s] %(message)s")    # level=logging. 에 오는 단계 이상 로그만 출력
...
# 파일
filename = datetime.now().strftime("mylogfile_%Y%m%d%H%M%S.log") # mylogfile_20231102112015.log
