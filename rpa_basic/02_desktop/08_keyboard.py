import pyautogui
w = pyautogui.getWindowsWithTitle("메모장")[0] # 메모장 1개 띄운 상태에서 가져옴
w.activate()

# pyautogui.write("12345", interval=0.02)
# pyautogui.write("NadoCoding", interval=1)
# pyautogui.write("나도코딩", interval=0.02)

# pyautogui.write(["t", "e", "s", "t", "left", "left", "right", "l", "a", "enter"], interval=0.02)
# t e s t 순서대로 적고 왼쪽 방향키 2번, 오른쪽 방향키 1번, l a 순서대로 적고 enter 입력

# https://automatetheboringstuff.com/2e/chapter20/
# ctrl + F, keyboard attributes 검색
# 각 키보드에 해당하는 이름 검색
